...
```
You should place the `data` folder in the `.`.
...
**F1 (entity) 35.73, F1 (Triple) 27.23**. The results are relatively low, which indicates the task is challenging and needs more powerful models. 
